...
public class ReadVersionsPublisherTest extends FlowPublisherVerification<Fragment> {
    ...
    public ReadVersionsPublisherTest() {
    ...
    public Flow.Publisher<Fragment> createFlowPublisher(long elements) {
        ...
        return persistence.readVersions(tx, timestamp.minusYears(1), timestamp.plusYears(1), "ns", "A", "1", null, 10000);
    }
