...
public class FindByPathAndValuePublisherTest extends FlowPublisherVerification<Fragment> {
    ...
    public FindByPathAndValuePublisherTest() {
    ...
    public Flow.Publisher<Fragment> createFlowPublisher(long elements) {
        ...
        return persistence.find(tx, timestamp.plusYears(1), "ns", "A", "$.k0", "v0".getBytes(StandardCharsets.UTF_8), null, 10000);
    }
