...
public class FindAllPublisherTest extends FlowPublisherVerification<Fragment> {
    ...
    public Flow.Publisher<Fragment> createFlowPublisher(long elements) {
        ...
        return persistence.findAll(tx, timestamp.plusYears(1), "ns", "A", null, 10000);
    }
